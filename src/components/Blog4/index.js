...
const Blog4 = () => {
    ...
    return(
        ...
        <div className="blog-container">
            ...
            Get Legal Advice Easily with Proptelligence
            </h1> 
